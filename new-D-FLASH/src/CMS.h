...
class CMS {
  private:
    ...
    */
    ...
    @param threshold: The minimum count that a local heavy hitter must have to be added to the top K
    candidate set.
  ...
  public:
    ...
    */
    ...
    /* For Debugging. Prints the heavy hitter and count for each element of the bucket for each hash
    function.

    @param sketchIndx: the index of the sketch to print the local heavy hitters and their counts
    from.
    */
