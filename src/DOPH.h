...
class DOPH {
  private:
    /* Core parameters. */
    unsigned int _rangePow; // Here _rangePow always means the power2 range
                            // of the hash table.
  ...
  public:
    ...
    */
    void getHashes(unsigned int *hashIndices, unsigned int *dataIds, unsigned int *dataIdx,
    ...
    Construct an DOPH class for optimal densified min-hash (for more details
